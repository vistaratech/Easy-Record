...
// Waits for auth hydration, then enforces user.role === 'admin'.
...
export default function AdminRoute({ children }: AdminRouteProps) {
  ...
  // Only proceed if the user object exists AND carries the 'admin' role.
  // Any other authenticated role (e.g. 'user', 'editor') is denied here.
