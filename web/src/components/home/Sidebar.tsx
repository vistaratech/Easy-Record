    ...
    <>
      ...
      <div className="mobile-topbar">
        ...
        <div className="mobile-topbar-brand">
          <img src="/logo-dark-text.png" alt="Easy Record" className="mobile-topbar-logo" />
      ...
      >
        <div className="sidebar-brand">
          <div className="sidebar-brand-group" onClick={() => navigate('/')}>
            <img src="/logo-dark-text.png" alt="Easy Record" className="sidebar-brand-logo" />
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <img src="/logo-dark-text.png" alt="Easy Record" className="sidebar-footer-logo" style={{ margin: 0 }} />
